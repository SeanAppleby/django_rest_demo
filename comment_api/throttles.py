...
class CombinedThrottle(throttling.UserRateThrottle):
    """
    This is the standard UserRateThrottle, just with rate pulled from the db.
    This is done so that an admin can adjust the value at runtime.
    """
    cache = default_cache
    timer = time.time
